...
推荐60g一个月或者128g一个月的，60g只能22元3个月，128G可以10元一个月，但是买的多折扣多。
适合学生党和偶尔看的人，且建议3个月以上付，月付最亏没任何性价比。

### 高速机场推荐2【<a href="https://vgvg.vg#/register?code=LL8e6l9E" target="_blank">一元机场(有传家宝但是随时跑路</a>】
真正的1元1个月，但是备用最好，作为主力不稳定
...
| ------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ | -------------------------------------------------- |
|clash-verge-rev   | [clash-verge-rev](https://github.com/clash-verge-rev/clash-verge-rev/releases/)    |  [clash-verge-rev](https://github.com/clash-verge-rev/clash-verge-rev/releases/)  |      |      |    支持linux    |   
...
| ShadowsocksR | [HMBSbige/SSR](https://github.com/HMBSbige/ShadowsocksR-Windows/releases)** |                                          | **[SSRR](https://github.com/shadowsocksrr/shadowsocksr-android/releases)** |                                                              |                                                     |
